          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  'Na raspolaganju se nalaze pomoćni gumbi "Resetiraj" i "Preskoči". Gumb "Resetiraj" iznova kreira trenutnu razinu i vraća figure na početne pozicije, koristan je ako nemamo više dostupnih poteza za učiniti. Gumbom "Preskoči" u potpunosti se preskače trenutna razina i odlazi se na sljedeću, koristan je ako zapnemo na razini.',
                  style: Styles.textDefault(context),
                ),
                const SizedBox(height: 24),
                ...
                const SizedBox(height: 12),
                Text(
                  'U postavkama možete odabrati veličinu fonta, tamnu ili svijetlu temu, uključiti ili isključiti zvuk ili odabrati font "OpenDyslexic" koji je prilagođen osobama s disleksijom. Postoji i gumb "Resetiraj napredak i postavke" koji vraća sve razine figura na prvu i sve postavke na zadane vrijednosti.',
                  style: Styles.textDefault(context),
                ),
                const SizedBox(height: 24),
              ],
